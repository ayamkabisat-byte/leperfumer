...
// Original: random recipe (no locks)
...
// Export full database for UI manual selection
export const FULL_DATABASE = DATABASE;

// Generate recipe with locked notes (manual selections preserved, rest randomized)
